# FFXIV Job Preferences and Roster
...
Aaron tends not to enjoy:

- Setup that feels like temporarily not attacking
- Weak audiovisual feedback
- Mechanics that feel busy without a satisfying payoff

A useful shorthand is that Aaron likes jobs where the buttons **feel like they matter**.

## Current Favorites / Main Contenders
...
### Future Jobs of Interest

- **Reaper** — dark aesthetic and big melee payoff; likely fun but may compete with SAM/DRK for similar emotional space.
- **Viper** — expected to fit the desire for fast, close, continuous combat without NIN's mudra friction.
- **Pictomancer** — curiosity remains; must pass the "oomph" test rather than feel like weak audiovisual pixie dust.

## Jobs That Did Not Click
...
## Personal Job Archetypes

Useful shorthand for recommendations:

- **SAM** — elegant violence
- **DRK** — heavy violence
- **GNB** — technical / bursty violence
- **MCH** — industrial violence
- **WAR** — immortal unga bunga
- **SCH** — tactical prevention
- **AST** — dynamic support/recovery
...
- favorite jobs
- jobs that unexpectedly click or stop clicking
- new role preferences
- major gameplay realizations
- explicit job-level milestones when Aaron asks them to be recorded

Only write changes to GitHub when Aaron explicitly asks to save/log/update the project.
